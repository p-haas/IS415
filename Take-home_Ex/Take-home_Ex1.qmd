...
we shall end our geospatial data wrangling by extracting the functional and non-functional water points located within the Osun State in Nigeria. Using the code chunks below help us do that. :::panel-tabset \### Functional Water Points
...
The kernel density maps reveal few concentrations of functional water points in certain location within the Osun State of Nigeria.

We observe peaks of up to 26 water points located within a bandwidth of ...

we find similar results with the non-functional water points.
...
-\> better understanding of the concentration, how much concentrated/dense?

Open question? Correlation between the two? What explains this concentration (outside the scope of this assignment)?
...
for (i in 1:30){
  ...
  plot(L_wp1.csr, . - r ~ r, xlab="d", ylab="L(d)-r", main = "L-test for Functional WP by Region")
}
```
...
for (i in 1:30){
  ...
  plot(L_wp2.csr, . - r ~ r, xlab="d", ylab="L(d)-r", main = "L-test for Non-Functional WP by Region")
}
```
:::
